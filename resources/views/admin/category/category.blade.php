<div class="page-header">
    ...
    {{-- <ul class="table-top-head">
        <li>
            <a href="{{ route('admin.category') }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Refresh"><i
    ...
    <div class="page-btn justify-content-end">
        <a href="javascript:void(0)" class="btn btn-added" data-bs-toggle="modal" data-bs-target="#add_category_modal"><i data-feather="plus-circle" class="me-2"></i>Create Category</a>
    </div>
</div>
<div class="card table-list-card">
    <div class="card-body">
        <div class="table-top">
            ...
            <input type="text" id="customSearchBox" placeholder="Search for categories" class="form-control " style="width: 25%">
            ...
            <div class="page-wrapper-new p-0">
                <div class="content">
                    ...
                    <div class="modal-body custom-modal-body">
                        <form id="category_form" action="{{ route('admin.add_category') }}" method="post"
...
@endsection
@section('category_custom_script')
    <script>
