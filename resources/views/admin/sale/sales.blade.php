    ...
    <div class="content">
        <div class="page-header">
            ...
            <ul class="table-top-head">
                <li>
                    <a href="{{ route('admin.sales') }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Refresh"><i data-feather="rotate-ccw" class="feather-rotate-ccw"></i></a>
                </li>
                <li>
                        ...
                        <div class="row sale_detail_sec mt-4 p-4">
                            ...
                            <div class="col-6">
                                ...
                                <div class="" style="margin: 20px 0">
                                    <select name="sale_customer"
                                        class="form-control selectbox_customer_v selectbox_customer"
                                        id="customer_selectbox"></select>
                                </div>
                        ...
                        <div class="col-12 col-sm-12 d-flex justify-content-between">
                            ...
                            <form id="deleteSaleForm" method="POST" action="">
                                ...
                                <div class="input-block">
                                    <input type="hidden" id="deleteAndUpdate" name="deleteAndUpdate" value="">
        ...
        <div class="modal fade" id="send_email_copy" aria-labelledby="sendEmailModalLabel" aria-hidden="true"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('admin.SendReceiptCopy') }}" method="post">
                            @csrf
...
@section('custom_script')
    ...
    <script type="text/javascript">
        ...
        $('#addCustomer').on("click", function(e) {
            ...
            $.ajax({
                url: "{{ route('admin.sale_add_customer') }}",
                type: "POST",
                data: {
                    _token: csrf,
        ...
        $('#Update_Customer').on("click", function(e) {
            ...
            $.ajax({
                url: "{{ route('admin.update_sale_customer') }}",
                type: "POST",
                data: {
                    _token: csrf,
                    sale_id: sale_id,
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            setTimeout(() => {
                                ...
                                var deleteSaleUrl = "{{ route('admin.delete_sale', ['id' => ':id']) }}".replace(':id', saleId);
                                if (saleId) {
        ...
        selectedValues.on('click', '.remove-value', function() {
            ...
            var selectedValue = $(document).find('.remove-value').filter(this).closest('.selected-value');
        ...
        $("#commission_update").click(function() {
            ...
            if (subtotal == checkAmount && totalPercentageAmount == percentage_value_amount) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.update_commission', 'id') }}",
                    type: 'POST',
                    data: {
                        sale_id: sale_id,
                        seller: seller,
        ...
        //     $.ajax({
        //         url: "{{ route('admin.saleGetCustomers') }}",
        //         type: "GET",
        //         dataType: "json",
        //         success: function(response) {
