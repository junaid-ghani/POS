...
@section('title', config('constants.site_title') . ' | Add Location')
@section('contents')
    <div class="content">
        <div class="page-header">
            ...
            <ul class="table-top-head">
                <li>
                    <div class="page-btn">
                        <a href="{{ route('admin.locations') }}" class="btn btn-secondary"><i data-feather="arrow-left"
                                class="me-2"></i>Back</a>
                    </div>
                </li>
                <li>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="location_phone_number"
                                        class="form-control phone_format_validate"
                                        value="{{ old('location_phone_number') }}" autocomplete="off">
