<div class="page-header justify-content-end">
    ...
    <div class="page-btn">
        {{-- <a href="{{ route('admin.add_product') }}" class="btn btn-added" ><i data-feather="plus-circle" class="me-2"></i>Create Item</a> --}}
        <a href="javascript:void(0)" class="btn btn-added" data-bs-toggle="modal" data-bs-target="#create_product"><i
                data-feather="plus-circle" class="me-2"></i>Create Item</a>
    </div>
</div>
        ...
        <div class="modal-content">
            <div class="page-wrapper-new p-0">
                <div class="content">
                    ...
                    <div class="modal-body custom-modal-body">
                        <form id="edit_product_form" action="{{ route('admin.edit_product') }}" method="post" enctype="multipart/form-data">
                        </form>
                    </div>
                </div>
            </div>
...
@section('product_custom_script')
    <script>
        ...
        function edit_product(product_id) {
            ...
            $.ajax({
                url: "{{ route('admin.view_edit_product') }}",
                type: "post",
