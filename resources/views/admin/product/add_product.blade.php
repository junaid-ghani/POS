...
@section('title',config('constants.site_title').' | Add Product')
@section('contents') --}}
{{-- <div class="content"> --}}
    {{-- <div class="page-header">
        ...
        <ul class="table-top-head">
            <li>
                <div class="page-btn">
                    <a href="{{ route('admin.items') }}" class="btn btn-secondary"><i data-feather="arrow-left" class="me-2"></i>Back</a>
                </div>
            </li>
            <li>
    ...
    <form id="product_form" action="{{ route('admin.add_product') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="product_code" class="form-control" value="{{ old('product_code') }}" autocomplete="off">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="mb-3 ">
                                ...
                                {{-- <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="validationDefaultUsername" placeholder="Username" aria-describedby="inputGroupPrepend2" required="" fdprocessedid="4nj4d9">
                                </div> --}}
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number" name="product_cost_price" class="form-control decimals" value="{{ old('product_cost_price') }}" autocomplete="off">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="mb-3">                                
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number" name="product_min_price" class="form-control decimals" value="{{ old('product_min_price') }}" autocomplete="off">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number" name="product_retail_price" class="form-control decimals" value="{{ old('product_retail_price') }}" autocomplete="off">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="product_priority" id="product_priority" class="form-control selectbox">
                                    ...
                                    <option value="4">4 - Worst Seller</option>
                                </select>
