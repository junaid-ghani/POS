            ...
            <div class="row mb-3">
                        ...
                        <select name="product_category" class="form-control selectbox">
                            ...
                            @foreach ($category_list as $category)
                                <option value="{{ $category->category_id }}"
                                    {{ $product->product_category == $category->category_id ? 'selected' : '' }}>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="product_cost_price" class="form-control decimals"
                                value="{{ $product->product_cost_price }}" autocomplete="off">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">$</span>
                            <input type="number" name="product_min_price" class="form-control decimals"
                                value="{{ $product->product_min_price }}" autocomplete="off">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">$</span>
                            <input type="number" name="product_retail_price" class="form-control decimals"
                                value="{{ $product->product_retail_price }}" autocomplete="off">
                        ...
                        <div>
                            @if (!empty($product->product_image))
                                <img src="{{ asset(config('constants.admin_path') . 'uploads/product/' . $product->product_image) }}"
                                    class="img-thumbnail" id="product_image_src" style="height: 100px" alt="">
                            @else
