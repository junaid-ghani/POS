...
<div class="content">
    <div class="page-header">
        ...
        <ul class="table-top-head">
            <li>
                <div class="page-btn">
                    <a href="{{ route('admin.customers') }}" class="btn btn-secondary"><i data-feather="arrow-left" class="me-2"></i>Back</a>
                </div>
            </li>
            <li>
    ...
    <form id="customer_form" action="{{ route('admin.edit_customer',['id'=>Request()->segment(3)]) }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-body">
                <div class="new-employee-field">
                    ...
                    <div class="row mb-3">
                        ...
                        @php
                            $customer_seller_ids = App\Models\CustomerSeller::where('customer_id', request()->segment(3))->pluck('seller_id')->toArray();
                        @endphp
