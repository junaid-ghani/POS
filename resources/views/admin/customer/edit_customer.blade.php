            ...
            <div class="row mb-3">
                <div class="col-lg-6 col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="customer_name" class="form-control"
                            value="{{ $customer->customer_name }}" autocomplete="off">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="customer_email" class="form-control"
                            value="{{ $customer->customer_email }}" autocomplete="off">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="customer_phone" class="form-control phone_format_validate"
                            value="{{ $customer->customer_phone }}" autocomplete="off">
