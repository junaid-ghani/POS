<div class="table-list-card">
    {{-- <div class="table-top">
        <div class="search-set">
            <div class="search_transfer_products">
    ...
    <div class="table-responsive">
        <table id="select_transfer_products" class="table" style="width: 100%">
            <thead>
                <tr>
                    <th>Select</th>
                    <th>Barcode</th>
            ...
            <tbody>
                @foreach ($products as $product)
                    <tr>
                        <td>
                            <input type="checkbox" class="transfer_checkbox" name="transfer_products[{{ $product->product_id }}]" value="{{ $product->product_id }}">
                        </td>
                        ...
                        <td>
                            ...
                            {{-- <small class="text-danger  qty_error" style="display: none"></small> --}}
...
<script>
    $('#select_transfer_products').DataTable({
        "bFilter": true,
        "sDom": 'fBtlpi',
        "ordering": true,
        "language": {
