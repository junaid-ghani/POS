                        ...
                        <div class="row mb-3">
                                    ...
                                    <table class="table table-bordered mb-0" style="width: 50%;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="mb-3">
                                                        <input type="number" name="commissions[FROM][2]"
                                                            class="form-control" readonly id="step2_from" value=""
                                                ...
                                                <td>
                                                    <div class="mb-3">
                                                        <input type="number" name="commissions[TO][2]"
                                                            class="form-control " id="step2_to" readonly
                                                            value="99999.99" placeholder="99999.99" autocomplete="off">
                                                        {{-- <small class="text-danger user_commission_error_step2"></small> --}}
                                                        <small class="text-danger " style="display:none"
                                                            id="step2_to_error"></small>
                                                ...
                                                <td>
                                                    <div class="mb-3">
                                                        <input type="number" name="commissions[FROM][3]"
                                                            class="form-control" readonly disabled value=""
                                                            id="step3_from" placeholder="0.00" autocomplete="off">
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="mb-3">
                                                        <input type="number" name="commissions[TO][3]" id="step3_to"
                                                            class="form-control " disabled readonly value="99999.99"
                                                            placeholder="99999.99" autocomplete="off">
                                                        {{-- <small class="text-danger user_commission_error_step2"></small> --}}
                                                        <small class="text-danger " style="display:none"
                                                            id="step3_to_error"></small>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="mb-3">
                                                        <input type="number" name="commissions[AMOUNT][3]"
                                                            class="form-control user_commission" disabled
                                                            placeholder="Enter Commission (%)" autocomplete="off">
                                                        <small class="text-danger user_commission_error"></small>
                                                    </div>
                                                </td>
                            ...
                            <div class="col-lg-6 col-md-6" id="fixed_commission_div" style="display: none">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="user_commission" class="form-control user_commission"
                                        id="user_commission_id" value="{{ old('user_commission') }}" autocomplete="off">
                                    <small class="text-danger user_commission_error"></small>
                                    @if ($errors->has('user_commission'))
                                        <small
                                            class="text-danger user_commission_error">{{ $errors->first('user_commission') }}</small>
                                    @endif
                                </div>
                            </div>
                        </div>
        ...
        $(document).ready(function() {
            ...
            $('.user_commission').on('input', function() {
                ...
                if (value < 1 || value > 100) {
                    // $(this).val('');
                    $(this).parent().find('.user_commission_error').html(
                        'Please enter a commission % value between 1-100');
