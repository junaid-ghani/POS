...
class AdminTransferProductController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.transfer_product.transfer_products',$data);
    }
    ...
    public function select_transfer_products(Request $request)
    {
        ...
        return view('admin.transfer_product.select_transfer_products',$data);
    }
    ...
    public function select_to_location(Request $request)
    {
        ...
        return view('admin.transfer_product.select_to_location',$data);
    }
}
